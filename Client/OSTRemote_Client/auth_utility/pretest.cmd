...
echo. %t0004%!psn!
fb2 oem getProjectCode 2>&1 | findstr getProjectCode | sed "s/getProjectCode: / %t0006%/g"
fb2 oem getSecurityVersion 2>&1 | findstr getSecurityVersion | sed "s/getSecurityVersion: / %t0007%/g"
...
fb2 getvar current-slot 2>&1 | findstr current-slot | sed "s/current-slot: / %t0020%/g"
