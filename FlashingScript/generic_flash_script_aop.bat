...
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFDNdRwWQNUi7Coks4evv+viCsXEaRuc4eZ2V07eBQA==
...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJhZksaHErTaQs=
::ZQ05rAF9IBncCkqN+0xwdVsFAlTMbCXrU9U=
::ZQ05rAF9IAHYFVzEqQIXLRVRXg2BfE22B6YU4eb8r9mEsEQNQKI5d52b+5u+QA==
::eg0/rx1wNQPfEVWB+kM9LVsJDAOHMm6oD7Yj7uT6/OK4sU4PXfIrR47UyvqLOOVz
::fBEirQZwNQPfEVWB+kM9LVsJDCOkD1SbKYUjz9reyMu1wg==
::cRolqwZ3JBvQF1fEqQIXLRVRXg2BfE22B6YU4eb8r9mEsEQNQKI5d52b+5u+QA==
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCiDJHGnwHEHFyt6dEnWbT6YS+VRuLjM2Kel8h4iWvYwdoPC5rOLLuUB40bbc5osxXJli8geBQtMQROkfkExsWsi
::YB416Ek+ZG8=
::
::
...
if "%fwver:~3,5%"=="AOP-0" set fuseissue=1
if "%fwver:~3,5%"=="AOP-1" set fuseissue=1
if "%fwver:~3,5%"=="AOP-2" set fuseissue=1
if "%fwver:~3,5%"=="AOP-3" set fuseissue=1
if "%fwver:~3,5%"=="AOP-4" set fuseissue=1
echo.
echo %fwver:~3,19%
echo.
pause
